...
This is my first published mod, so there might be some jank. I have tested it in my modded ATM10 6.6 world and have not encountered any issues.
...
By default, FreeHands checks your main hand first, then your offhand. You can change this order in the mod config.

Also by default, FreeHands does not place items into your hotbar. You can change this in the config. When hotbar destinations are enabled, slots are checked from left to right.
