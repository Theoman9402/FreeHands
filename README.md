...
Also by default, it does not place items into your hotbar. You can change this in the config so it goes through your inventory first and then the hotbar.
