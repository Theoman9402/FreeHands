...
public final class FreeHandsClientConfig {
    ...
    public static final ModConfigSpec.BooleanValue TRY_OTHER_HAND = BUILDER
            .translation("freehands.configuration.tryOtherHand")
            .comment("If the first hand cannot fit, try the other hand for stacking.")
            .define("tryOtherHand", false);
